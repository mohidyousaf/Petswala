...
class ServicePage extends StatelessWidget {
  ...
  final ServiceInfo service = ServiceInfo(
      name: 'Adil', 
      rate: 120, 
      description: "Dedicated veterinarian seeking positions in the Seattle area. Skilled in treating animals, working in high-pressure environments and problem-solving. Passionate about educating pet owners on their pets' health and well-being, as well as advocating for animal rights.",
      type: 'Vet',
          ...
          Column(
              ...
              children: [
                Container(
                  ...
                  child: Image.asset(service.imLink,fit: BoxFit.fill,),
                ),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Align(
                            ...
                            child: Text('Description:  ',style: AppFont.bodyLarge(AppColor.gray_dark))),
                          Expanded(
                              child: Padding(
                      ...
                      Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          Text('Type:  ',style: AppFont.bodyLarge(AppColor.gray_dark)),
                          Padding(
                              padding: const EdgeInsets.symmetric(vertical: 8),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text('${service.rating}', style: AppFont.bodyLarge(AppColor.black)),
                          ],
                        ),
                      ),
                      SizedBox(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          mainAxisAlignment:MainAxisAlignment.start,
                          children: [
                            Text('Contact:  ',style: AppFont.bodyLarge(AppColor.gray_dark)),
                            Text('${service.contact}', style: AppFont.bodyLarge(AppColor.black)),
                          ],
                        ),
                      )
                    ],
